...
export const products: Product[] = [
  ...
  // Steam Dhokla Machine
  {
    ...
    variants: [
      ...
      { id: 'sd-193', name: '10 Tray Steam Dhokla Machine', modelNo: 'SD-193', price: 29050, weight: '35 kg', bodyMaterial: 'SS Body', size: '24 x 24 x 47', gstPercent: 18, description: '10 tray steam dhokla machine.' },
