...
export const products: Product[] = [
  ...
  // Namkeen Making Machine
  {
    ...
    variants: [
      ...
      { id: 'nm-02', name: '9 Inch Namkeen Machine', modelNo: 'NM-02', price: 17950, weight: '80 kg', bodyMaterial: 'SS Body', size: '46X41X13', capacity: '100-150 KG', motor: '1 hp', gstPercent: 18, description: 'Namkeen making machine or farshan machine is use for making various type of namkeen like sev, gathiya, papdi, etc.' },
    ],
  },
  // Namkeen Pan Coating Machine
  {
    ...
    description: 'Masala Coating Machine is used for any kind of snacks flavoring purpose. Flavor coating to Corn Puff, Rice Puff, Cheese balls, Peanuts, Kurkure, etc. Coating Pan machine, chips mixer is used to add flavour in namkeen, chips and nut.',
    image: namkeenMixer,
    basePrice: 31600,
    variants: [
  ...
  // Potato Peeler Machine
  {
    ...
    variants: [
      ...
      { id: 'ppm-102', name: 'Potato Peeler Machine 10 kg', modelNo: 'PPM-102', price: 13750, weight: '44 kg', bodyMaterial: 'SS Body', size: '31 x 28 x 17', capacity: '10 Kg', motor: '0.75 Hp', gstPercent: 18, description: 'These professional stainless steel electric potato peelers makes quick work of all your potato peeling needs with an output capacity of 10 kg per batch.' },
      { id: 'ppm-103', name: 'Potato Peeler Machine 15 kg', modelNo: 'PPM-103', price: 18450, weight: '56 kg', bodyMaterial: 'SS Body', size: '33 X 31 X 19', capacity: '15 kg', motor: '1.5 Hp', gstPercent: 18, description: 'These professional stainless steel electric potato peelers makes quick work of all your potato peeling needs with an output capacity of 15 kg per batch.' },
      { id: 'ppm-104', name: 'Potato Peeler Machine 20 Kg', modelNo: 'PPM-104', price: 22150, weight: '59 kg', bodyMaterial: 'SS Body', size: '33 X 34 X 19', capacity: '20 kg', motor: '2 Hp', gstPercent: 18, description: 'These professional stainless steel electric potato peelers makes quick work of all your potato peeling needs with an output capacity of 20 kg per batch.' },
      { id: 'ppm-105', name: 'Potato Peeler Machine 30 kg', modelNo: 'PPM-105', price: 34750, weight: '100 kg', bodyMaterial: 'SS Body', size: '35 X 44 X 20', capacity: '30 kg', motor: '2 Hp', gstPercent: 18, description: 'These professional stainless steel electric potato peelers makes quick work of all your potato peeling needs with an output capacity of 30 kg per batch.' },
    ],
  },
  // Powder Masala Mixer Machine
  {
    ...
    description: 'Masala mixer is a machine that with ribbon on its shaft that helps to blend everything perfectly and in effective way. Masala mixer is used to mix namkeen, powders, masala and chemicals at namkeen factory, powder factory and chemicals factories.',
    image: namkeenMixer,
    basePrice: 44200,
    variants: [
      { id: 'pmmm-101', name: '2 Feet Powder Masala Mixer Machine', modelNo: 'PMMM-101', price: 44200, weight: '190 kg', bodyMaterial: 'SS 304 BODY', size: '54 x 40 x 25', motor: '1.5 Hp', gstPercent: 18, description: 'Masala mixer is a machine that with ribbon on its shaft that helps to blend everything perfectly.' },
      { id: 'pmmm-102', name: '3 Feet Powder Masala Mixer Machine', modelNo: 'PMMM-102', price: 68250, weight: '210 kg', bodyMaterial: 'SS 304 BODY', size: '66 x 45 x 25', motor: '2 Hp', gstPercent: 18, description: 'Masala mixer is a machine that with ribbon on its shaft that helps to blend everything perfectly.' },
      { id: 'pmmm-103', name: '5 Feet Powder Masala Mixer Machine', modelNo: 'PMMM-103', price: 98250, weight: '370 kg', bodyMaterial: 'SS 304 BODY', size: '91 x 48 x 31', motor: '3 Hp', gstPercent: 18, description: 'Masala mixer is a machine that with ribbon on its shaft that helps to blend everything perfectly.' },
    ],
  },
  // Roti Making Machine
  {
    ...
    isFeatured: true,
    variants: [
      { id: 'c-300', name: 'C-300 Automatic Roti Machine', modelNo: 'C-300', price: 60000, weight: '82 kg', bodyMaterial: 'SS Body', size: '30 X 18 X 35', capacity: '300/Hour', motor: '0.25 HP(H.P.)', gstPercent: 18, description: 'World\'s Compact Size, 3 Belt Conveyor, S.S. Burner, Less Gas Consumption.' },
      { id: 'srm-01', name: 'Premium Automatic Roti Machine 500/hr', modelNo: 'SRM-01', price: 85000, weight: '125 kg', bodyMaterial: 'SS Body', size: '44 X 21 X 42', capacity: '500 pr/hr', motor: '0.25 HP', gstPercent: 18, description: 'Premium automatic roti machine with 304 S.S. (3 Layers) conveyor belt.' },
      { id: 'rc-5', name: 'Premium Automatic Roti Machine 700 pr/hr', modelNo: 'RC-5', price: 110000, weight: '140 kg', bodyMaterial: 'S.S. BODY', size: '51x19x44', capacity: '700+ ROTI PR / HR', motor: '0.5 HP', gstPercent: 18, description: 'Premium automatic roti machine 700 roti per hour.' },
      { id: 'da-01', name: 'Double Plate Automatic Roti Machine Set', modelNo: 'DA-01', price: 125000, weight: '240 kg', bodyMaterial: 'SS Body', size: '65 x 50 x 54', capacity: '800 TO 1000', motor: '1 HP + 120V', gstPercent: 18, description: 'The machine can make chapati perfectly and with a capacity of 800-1000 chapati per hour.' },
      { id: 'rc-4', name: 'Premium Automatic Roti Machine 1000 Roti pr/hr', modelNo: 'RC-4', price: 130000, weight: '210 kg', bodyMaterial: 'S.S. BODY', size: '60x23x48', capacity: '900-1000 PR/HR', motor: '1 HP FHP', gstPercent: 18, description: 'High capacity premium automatic roti machine.' },
      { id: 'c-800', name: 'C-800 14" Automatic Roti Machine Big Size', modelNo: 'C-800', price: 165000, weight: '250 kg', bodyMaterial: 'NS Body', size: '60 X 25 X 50', capacity: '800/Hour', motor: '1 H.P.', gstPercent: 18, description: 'Big Size Roti 12" Swami Roti & Rumali Roti, Thickness Adjustable, Powerfull S.S. Burners.' },
      { id: 'rc-1', name: 'Roti Machine Set Conveyor Non-stick plate type (1000 roti/hr)', modelNo: 'RC-1', price: 170000, weight: '420 kg', bodyMaterial: 'SS Body', size: '73 x 26 x 56', capacity: '800 TO 1000', motor: '1 HP', gstPercent: 18, description: 'Conveyor type automatic roti making machine non-stick plate type.' },
  ...
  // Roti Pressing Machine
  {
    ...
    variants: [
      ...
      { id: 'hrm-01', name: 'Handpress Roti Machine', modelNo: 'HRM-01', price: 25200, weight: '35 kg', bodyMaterial: 'MS Body', size: '20 x 12 x 31', capacity: '400/HR', motor: '2 x 1500 watt', gstPercent: 18, description: 'Simply place a ball of dough on the middle of the bottom plate and then use the handle to press down the top plate. It makes preparing rotis or chapatis easy and hassle-free.' },
      { id: 'rpm-s', name: 'Premium Roti Pressing Machine 9inch (500 Roti/hr)', modelNo: 'RPM-S', price: 26000, weight: '31 kg', bodyMaterial: 'SS Body', size: '13 X 14 X 17', capacity: '400-500 Roti pr/hr', motor: '0.25 Hp', gstPercent: 18, description: '9 inch premium roti pressing machine.' },
      { id: 'p-700', name: 'P-700 Roti Pressing Machine Premium', modelNo: 'P-700', price: 29000, weight: '31 kg', bodyMaterial: 'SS Body', size: '13\' X 14\' X 17', capacity: '600-700/Hour', motor: '0.25 H.P.', gstPercent: 18, description: 'P-700 premium roti pressing machine.' },
      { id: 'r-7', name: 'Premium Roti Pressing Machine 1000 Roti pr/Hr', modelNo: 'R-7', price: 32000, weight: '40 kg', bodyMaterial: 'S.S. BODY', size: '20x15x22', capacity: '1000+ ROTI PR/HR', motor: '1 HP', gstPercent: 18, description: 'Premium roti pressing machine 1000 roti per hour.' },
      { id: 'r-1', name: 'Roti Pressing Machine', modelNo: 'R-1', price: 43000, weight: '92 kg', bodyMaterial: 'SS Body', size: '35 x 22 x 25', capacity: '900 TO 1000', motor: '1 hp', gstPercent: 18, description: 'Our semi auto Roti making machine designed for commercial use.' },
  ...
  // Steam Dhokla Machine
  {
    ...
    variants: [
      ...
      { id: 'sd-102', name: '8 Tray Steam Dhokla Machine', modelNo: 'SD-102', price: 17450, weight: '48 kg', bodyMaterial: 'SS Body', size: '24 x 24 x 45', gstPercent: 18, description: 'SS steam Dhokala machine is use to make Dhokla, idli khaman etc. Tray Size: 14"x18"x1.25, Aluminium tray.' },
      { id: 'sd-103', name: '10 Tray Steam Dhokla Machine', modelNo: 'SD-103', price: 20050, weight: '51 kg', bodyMaterial: 'SS Body', size: '24 x 24 x 47', gstPercent: 18, description: 'SS steam Dhokala machine is use to make Dhokla, idli khaman etc. Tray Size: 14"x18"x1.25, Aluminium tray.' },
      { id: 'sd-104', name: '12 Tray Steam Dhokla Machine', modelNo: 'SD-104', price: 22600, weight: '58 kg', bodyMaterial: 'SS Body', size: '24 x 24 x 52', gstPercent: 18, description: 'SS steam Dhokala machine is use to make Dhokla, idli khaman etc. Tray Size: 14"x18"x1.25, Aluminium tray.' },
    ],
  },
  // Naylon Khaman Machine
  {
    ...
    variants: [
      ...
      { id: 'sd-106', name: '8 Plate Naylon Khaman Machine', modelNo: 'SD-106', price: 24250, weight: '66 kg', bodyMaterial: 'SS Body', size: '28 x 24 x 56', gstPercent: 18, description: 'In Khaman Dhokla Machine you can prepare soft and spongy instant dhokla in less than 20 minutes. Tray Size: 18"x18"x2.5, Aluminium tray.' },
      { id: 'sd-107', name: '10 Plate Naylon Khaman Machine', modelNo: 'SD-107', price: 26500, weight: '75 kg', bodyMaterial: 'SS Body', size: '28 x 24 x 66', gstPercent: 18, description: 'In Khaman Dhokla Machine you can prepare soft and spongy instant dhokla in less than 20 minutes. Tray Size: 18"x18"x2.5, Aluminium tray.' },
      { id: 'sd-108', name: '6 Plate Naylon Khaman Machine (with chhapari)', modelNo: 'SD-108', price: 25800, weight: '74 kg', bodyMaterial: 'SS Body', size: '28 x 24 x 56', gstPercent: 18, description: 'In Khaman Dhokla Machine you can prepare soft and spongy instant dhokla in less than 20 minutes. Tray Size: 18"x18"x2.5, Aluminium tray.' },
      { id: 'sd-109', name: '8 Plate Naylon Khaman Machine (with chhapari)', modelNo: 'SD-109', price: 29000, weight: '84 kg', bodyMaterial: 'SS Body', size: '28 x 24 x 63', gstPercent: 18, description: 'In Khaman Dhokla Machine you can prepare soft and spongy instant dhokla in less than 20 minutes. Tray Size: 18"x18"x2.5, Aluminium tray.' },
      { id: 'sd-110', name: '10 Plate Naylon Khaman Machine (with chhapari)', modelNo: 'SD-110', price: 47500, weight: '103 kg', bodyMaterial: 'SS Body', size: '28 x 24 x 74', gstPercent: 18, description: 'In Khaman Dhokla Machine you can prepare soft and spongy instant dhokla in less than 20 minutes. Tray Size: 18"x18"x2.5, Aluminium tray.' },
    ],
  },
  // Sugarcane Juicer
  {
    ...
    variants: [
      ...
      { id: 'sp-01', name: 'Sugarcane Peeler Machine', modelNo: 'SP-01', price: 14600, weight: '65 kg', bodyMaterial: 'SS Body', gstPercent: 18, description: 'This sugarcane peeling machine can peel the sugarcane skin automatically, it can solve the difficulties of traditional peeling effectively.' },
      { id: 'ssc-01', name: 'Sugarcane Juicer Machine Slim', modelNo: 'SSC-01', price: 19000, weight: '35 kg', bodyMaterial: 'SS Body', size: '16 x 11 x 17', capacity: '200 TO 250 (Glass)', motor: '0.5 hp', gstPercent: 18, description: 'Our sugarcane juice machine extracts juice from sugarcane by squeezing it with three SS 304 diamond-cut rollers. Cycloid Gear Box.' },
      { id: 'se-01', name: 'Sugarcane Juicer Machine Engine Model', modelNo: 'SE-01', price: 19500, weight: '88 kg', bodyMaterial: 'SS Body', size: '36 x 18 x 43', capacity: '200 TO 250 (Glass)', gstPercent: 18, description: 'Our sugarcane juice machine extracts juice from sugarcane by squeezing it with three SS 304 diamond-cut rollers.' },
      { id: 'sjht-01', name: 'Sugarcane Juicer Hygienic', modelNo: 'SJHT-01', price: 21500, weight: '35 kg', bodyMaterial: 'SS Body', size: '27\' X 13\' X 24\'', capacity: '200 TO 300 Glass PR HR APPROX', motor: '1 H.P.', gstPercent: 18, description: 'S.S Hardness Diamond Roller, Maintenance-Free Helical Gear System, In Side & Out side S.S Body, Easy To Washing & Clean, Table Top & Jumbo Model. Roll: S.S Diamond Solid Roll.' },
      { id: 'sem-01', name: 'Sugarcane Juicer Machine Engine Model With Motor', modelNo: 'SEM-01', price: 23600, weight: '110 kg', bodyMaterial: 'SS Body', size: '36 x 18 x 43', capacity: '200 TO 250 (Glass)', motor: '1.5 hp', gstPercent: 18, description: 'Our sugarcane juice machine extracts juice from sugarcane by squeezing it with three SS 304 diamond-cut rollers.' },
      { id: 'sjhj-01', name: 'Sugarcane Juicer Machine Hygienic Jumbo', modelNo: 'SJHJ-01', price: 24500, weight: '40 kg', bodyMaterial: 'SS Body', size: '27\' X 13\' X 36\'', capacity: '300 TO 400 Glass PR HR APPROX', motor: '1.5 H.P.', gstPercent: 18, description: 'S.S Hardness Diamond Roller, Maintenance-Free Helical Gear System, In Side & Out side S.S Body, Easy To Washing & Clean, Table Top & Jumbo Model. Roll: S.S Diamond Solid Roll.' },
    ],
  },
  ...
  // Vegetable Cutting Machine
  {
    ...
    isNewArrival: true,
    variants: [
      { id: 'ccm-01', name: 'Onion And Chilly Cutter Machine', modelNo: 'CCM-01', price: 7750, weight: '25 kg', bodyMaterial: 'SS Body', size: '25 x 20 x 12', capacity: '30-40 KG', motor: '1 hp', gstPercent: 18, description: 'It is used for cutting Chilly also onion. The Cutting of this machine is in a smooth & best way for cooking industries.' },
      { id: 'ccm-101', name: '1 Hp Onion & Chilly Cutter Premium Model', modelNo: 'CCM-101', price: 9050, weight: '31 kg', bodyMaterial: 'SS Body', size: '20 x 14 x 26', capacity: '30 TO 40 Kg', motor: '1 Hp, 960 RPM', gstPercent: 18, description: 'It is used for cutting Chilly also onion. The Cutting of this machine is in a smooth & best way for cooking industries. Jali: 4 Nos.' },
      { id: 'os-01', name: 'Onion Slicer', modelNo: 'OS-01', price: 11450, weight: '41 kg', bodyMaterial: 'SS Body', size: '25 x 24 x 12', capacity: '125-150 KG', motor: '0.5 H.P.', gstPercent: 18, description: 'Onion Slicer or Slicing machine can be used for preparing rings or slices of Onion for Hotels, restaurants, or commercial purpose.' },
      { id: 'vcm-01', name: 'Vegetable Cutting Machine 1 Hp', modelNo: 'VCM-01', price: 13950, weight: '40 kg', bodyMaterial: 'SS Body', size: '40 x 22 x 12', capacity: '150-200 KG', motor: '1 HP', gstPercent: 18, description: 'The vegetable cutting machine is a multi-function cutter to slice, chop, dice or julienne vegetables. Blade: 8 Nos (1 Set).' },
      { id: 'ccm-102', name: '2 Hp Onion & Chilly Cutter', modelNo: 'CCM-102', price: 15850, weight: '50 kg', bodyMaterial: 'SS Body', size: '23 x 26 x 14', capacity: '80 kg', motor: '2 Hp, 1440 RPM', gstPercent: 18, description: 'It is used for cutting Chilly also onion. The Cutting of this machine is in a smooth & best way for cooking industries. Jali set: 4 Nos / Set.' },
      { id: 'cc-01', name: 'Cabbage Cutter Machine', modelNo: 'CC-01', price: 16400, weight: '45 kg', bodyMaterial: 'SS Body', size: '29 x 23 x 19', capacity: '300kg', motor: '1 hp', gstPercent: 18, description: 'A cabbage cutter is a machine that speeds up the cutting process of cabbage which helps various restaurants and cafes as well as other food industries.' },
      { id: 'vcm-03', name: 'Vegetable Cutting Machine Delux Model', modelNo: 'VCM-03', price: 19550, weight: '40 kg', bodyMaterial: 'Ms Body', size: '40 x 22 x 12', capacity: '150-200 KG', motor: '1 hp', gstPercent: 18, description: 'The vegetable cutting machine is a multi-function cutter to slice, chop, dice or julienne vegetables. Blade: 8 blade (1 set).' },
      { id: 'vcm-02', name: 'Vegetable Cutting Machine Heavy 2 Hp', modelNo: 'VCM-02', price: 36850, weight: '90 kg', bodyMaterial: 'SS Body', size: '45 x 28 x 19', capacity: '500-600 KG', motor: '2 Hp', gstPercent: 18, description: 'The vegetable cutting machine is a multi-function cutter to slice, chop, dice or julienne vegetables. Blade: 7 Nos (1 Set).' },
    ],
  },
  // Wafer Slicer Machine
  {
    id: 'wafer-slicer-1',
    name: 'Potato Slicer Machine',
