...
export const products: Product[] = [
  ...
  // Gravy Making Machine
  {
    ...
    description: 'Commercial gravy making machine for restaurants and catering. Available in 5 to 40 litre capacity.',
    image: gravyMachine,
    basePrice: 9500,
    variants: [
      { id: 'gm-01', name: 'Gravy Making Machine 5 Ltr', modelNo: 'GM-01', price: 9500, weight: '25 kg', bodyMaterial: 'SS Body', motor: '0.5 hp', gstPercent: 18, description: '5 litre gravy maker' },
      { id: 'gm-02', name: 'Gravy Making Machine 10 Ltr', modelNo: 'GM-02', price: 12500, weight: '30 kg', bodyMaterial: 'SS Body', motor: '1 hp', gstPercent: 18, description: '10 litre gravy maker' },
      { id: 'gm-03', name: 'Gravy Making Machine 20 Ltr', modelNo: 'GM-03', price: 18500, weight: '40 kg', bodyMaterial: 'SS Body', motor: '1.5 hp', gstPercent: 18, description: '20 litre gravy maker' },
      { id: 'gm-04', name: 'Gravy Making Machine 40 Ltr', modelNo: 'GM-04', price: 25000, weight: '50 kg', bodyMaterial: 'SS Body', motor: '2 hp', gstPercent: 18, description: '40 litre gravy maker' },
    ],
  },
  // Mixer Grinder
  {
    ...
    description: 'Commercial mixer grinder available in standard, square, and tilting models from 0.5 HP to 3 HP.',
    image: mixerGrinder,
    basePrice: 4900,
    isFeatured: true,
    variants: [
      { id: 'm-101', name: '0.5 Hp Mixer Grinder 2.5 Ltr', modelNo: 'M-101', price: 4900, weight: '10 kg', bodyMaterial: 'SS Body', size: '19 x 6 x 20', capacity: '2.5 Litre', motor: '0.5 Hp 2900 RPM', gstPercent: 18, description: '0.5 HP compact mixer grinder' },
      { id: 'm-101b', name: '1 HP Mixer Grinder 2 Ltr', modelNo: 'M-101', price: 6500, weight: '30 kg', bodyMaterial: 'SS Body', size: '10x15x22', motor: '1 HP', gstPercent: 18, description: '1 HP mixer grinder 2 litre' },
      { id: 'm-102', name: '1.5 HP Mixer Grinder 3 Ltr', modelNo: 'M-102', price: 7250, weight: '33 kg', bodyMaterial: 'SS Body', size: '10x15x22', capacity: '3 Liter', motor: '1.5 HP', gstPercent: 18, description: '1.5 HP mixer grinder 3 litre' },
      { id: 'm-103', name: '1.5 HP Mixer Grinder 5 Ltr', modelNo: 'M-103', price: 7350, weight: '33 kg', bodyMaterial: 'SS Body', size: '10x14x26', capacity: '5 Liter', motor: '1.5 HP', gstPercent: 18, description: '1.5 HP mixer grinder 5 litre' },
      { id: 'm-104', name: '2 HP Mixer Grinder 5 Ltr', modelNo: 'M-104', price: 7870, weight: '35 kg', bodyMaterial: 'SS Body', size: '10x14x26', capacity: '5 Liter', motor: '2 HP', gstPercent: 18, description: '2 HP mixer grinder 5 litre' },
      { id: 'm-105', name: '2 HP Mixer Grinder 10 Ltr', modelNo: 'M-105', price: 8400, weight: '35 kg', bodyMaterial: 'SS Body', size: '10x14x26', capacity: '10 Liter', motor: '2 HP', gstPercent: 18, description: '2 HP mixer grinder 10 litre' },
      { id: 'm-106', name: '2 HP Mixer Grinder 10 Ltr With Pipe', modelNo: 'M-106', price: 8900, weight: '36 kg', bodyMaterial: 'SS Body', size: '10x20x27', capacity: '10 Liter', motor: '2 HP', gstPercent: 18, description: '2 HP mixer grinder 10 litre with pipe' },
      { id: 'm-107', name: '1.5 HP Mixer Grinder Square Model 5 Ltr', modelNo: 'M-107', price: 8500, weight: '36 kg', bodyMaterial: 'SS Body', size: '17x22x27', capacity: '5 Liter', motor: '1.5 HP', gstPercent: 18, description: '1.5 HP square model mixer grinder' },
      { id: 'm-108', name: '2 HP Mixer Grinder Square Model 5 Ltr', modelNo: 'M-108', price: 9000, weight: '38 kg', bodyMaterial: 'SS Body', size: '22x27x33', capacity: '5 Liter', motor: '2 HP', gstPercent: 18, description: '2 HP square model mixer grinder' },
      { id: 'm-109', name: '2 HP Mixer Grinder Square Model 10 Ltr', modelNo: 'M-109', price: 9550, weight: '40 kg', bodyMaterial: 'SS Body', size: '12x32x15', capacity: '10 Liter', motor: '2 HP', gstPercent: 18, description: '2 HP square model 10 litre' },
      { id: 'm-110', name: '3 HP Mixer Grinder Square Model 14 Ltr', modelNo: 'M-110', price: 13950, weight: '45 kg', bodyMaterial: 'SS Body', size: '14x15x37', capacity: '14 Liter', motor: '3 HP', gstPercent: 18, description: '3 HP square model 14 litre' },
      { id: 'm-111', name: '1.5 HP Mixer Grinder Tilting Model 5 Ltr', modelNo: 'M-111', price: 9550, weight: '38 kg', bodyMaterial: 'SS Body', size: '23x18x35', capacity: '5 Liter', motor: '1.5 HP', gstPercent: 18, description: '1.5 HP tilting model 5 litre' },
      { id: 'm-112', name: '2 HP Mixer Grinder Tilting Model 5 Ltr', modelNo: 'M-112', price: 10080, weight: '41 kg', bodyMaterial: 'SS Body', size: '23x18x35', capacity: '5 Liter', motor: '2 HP', gstPercent: 18, description: '2 HP tilting model 5 litre' },
      { id: 'm-113', name: '2 HP Mixer Grinder Tilting Model 10 Ltr', modelNo: 'M-113', price: 10600, weight: '43 kg', bodyMaterial: 'SS Body', size: '23x18x40', capacity: '10 Liter', motor: '2 HP', gstPercent: 18, description: '2 HP tilting model 10 litre' },
      { id: 'm-114', name: '3 HP Mixer Grinder Tilting Model 14 Ltr', modelNo: 'M-114', price: 14800, weight: '49 kg', bodyMaterial: 'SS Body', size: '25x19x49', capacity: '14 Liter', motor: '3 HP', gstPercent: 18, description: '3 HP tilting model 14 litre' },
    ],
  },
  ...
  // High Speed Powder Grinder
  {
    ...
    description: 'High speed powder grinder for grinding spices, grains, and other dry materials.',
    image: powderGrinder,
    basePrice: 8800,
    variants: [
      { id: 'hsrw-302', name: '500G High Speed Powder Grinder', modelNo: 'HSRW-302', price: 8800, weight: '5 kg', bodyMaterial: 'SS', capacity: '500 GM', motor: '220 V 2300 W', gstPercent: 18, description: '500g high speed powder grinder' },
      { id: 'rbspg-003', name: '1 Kg High Speed Powder Grinder', modelNo: 'RBSPG 003', price: 10000, weight: '7 kg', bodyMaterial: 'SS', capacity: '1 KG', motor: '2800 w 2800 RPM', gstPercent: 18, description: '1 Kg high speed powder grinder' },
      { id: 'hswg-10s', name: '1.5 Kg High Speed Powder Grinder', modelNo: 'HSWG-10S', price: 11200, weight: '5 kg', bodyMaterial: 'SS-304', size: '9" X 9" X 13"', capacity: '1500 Gm', gstPercent: 18, description: '1.5 Kg high speed powder grinder' },
      { id: 'rspg-j06', name: '2.5 Kg High Speed Powder Grinder', modelNo: 'RSPG-J06', price: 14800, weight: '5 kg', bodyMaterial: 'SS Steel', size: '8" X 5" X 13"', motor: '4000W', gstPercent: 18, description: '2.5 Kg high speed powder grinder' },
      { id: 'hspm-304', name: '3.5 Kg High Speed Powder Grinder', modelNo: 'HSPM-304', price: 16900, weight: '11 kg', bodyMaterial: 'SS', size: '11 x 9 x 17 inch', capacity: '3.5 KG', motor: '5000 W', gstPercent: 18, description: '3.5 Kg high speed powder grinder' },
    ],
  },
  // Laddu & Jamun Ball Making Machine
  {
    ...
    description: 'Commercial laddu and jamun ball making machine for sweet shops.',
    image: ladduMaker,
    basePrice: 105000,
    variants: [
      { id: 'lmm-01', name: 'Laddu Making Machine (Single Worm Type)', modelNo: 'LMM-01', price: 105000, weight: '40 Kg', bodyMaterial: 'SS Body', size: '56 x 26 x 42', capacity: '1200 TO 1500 P/Hr', motor: '1 Hp', gstPercent: 18, description: 'Single worm type laddu making machine' },
      { id: 'lmm-01b', name: 'Laddu Making Machine (Single Worm Type) Heavy', modelNo: 'LMM-01', price: 105000, weight: '200 KG', bodyMaterial: 'SS Body', size: '56.4.56 × 62', capacity: '1200 TO 1500 P/Hr', motor: '1.5 hp', gstPercent: 18, description: 'Heavy single worm type laddu making machine' },
      { id: 'jb-01', name: 'Jamun Ball Making Machine', modelNo: 'JB-01', price: 160000, weight: '90 Kgs', bodyMaterial: 'SS-304', capacity: '20 x 24 mm 1500 to 3500 P/Hr', motor: '1 hp', gstPercent: 18, description: 'Jamun ball making machine' },
    ],
  },
  // Milk Mawa (Khoya) Machine
  {
    ...
    description: 'Commercial milk mawa (khoya) machine for dairy products. Available in 55 to 100 litre.',
    image: mawaMachine,
    basePrice: 58000,
    variants: [
      { id: 'marm-15m', name: '55 Liter Milk Mawa (Khoya) Machine', modelNo: 'MARM-15M', price: 58000, weight: '200 Kg', bodyMaterial: 'SS (fully)', size: '47x26x52', motor: '0.5 HP', gstPercent: 18, description: '55 litre standard mawa machine' },
      { id: 'mam-04', name: '55 Liter Milk Mawa (Khoya) Machine Tilting', modelNo: '04AM-04', price: 64000, bodyMaterial: 'SS Body', size: '52x26x56', capacity: '55 LTR', motor: '0.5 HP (1440 RPM)', gstPercent: 18, description: '55 litre tilting mawa machine' },
      { id: 'mmm-06', name: '100 Liter Milk Mawa (Khoya) Machine', modelNo: 'MMM-06', price: 69000, mrp: 85195, weight: '230 kg', bodyMaterial: 'SS', size: '51x32x39 in', motor: '3 HP 1440 RPM', gstPercent: 18, description: '100 litre standard mawa machine' },
      { id: 'mbm-05', name: '100 Liter Milk Mawa (Khoya) Machine Tilting', modelNo: 'MBM/05', price: 75000, bodyMaterial: 'SS Body', size: '57x52x60', capacity: '100 LTR', motor: '1 HP (1440 RPM)', gstPercent: 18, description: '100 litre tilting mawa machine' },
    ],
  },
];
